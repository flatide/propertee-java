package com.flatide.propertee.cli;

import com.flatide.propertee.core.ScriptParser;
...
import com.flatide.propertee.task.SimpleTaskRunner;
import com.flatide.propertee.parser.ProperTeeParser;
    ...
    public void run() {
        ...
        try {
            while (true) {
                ...
                ProperTeeParser.RootContext tree = ScriptParser.parse(text, errors);
                if (tree == null) {
