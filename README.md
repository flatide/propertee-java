...
TeeBox (the HTTP execution proxy service) has been moved to a [separate repository](https://github.com/flatide/TeeBox). It depends on `propertee-core:0.7.0`.
